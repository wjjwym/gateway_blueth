    ...
    #endif
    {
        ...
        #else
        if ((fd = open(dev_event, O_RDONLY)) < 0)
        {
            perror("evtest");
            return 1;
        }
        ...
        while (1)
        {
            ...
            for (i = 0; i < rd / sizeof(struct input_event); i++)
            {
                ...
                {//key
                    if(163 == ev[i].code)
                    {
                        printf("recv next song key\n");
                    }
                    else if(165 == ev[i].code)
                    {
                        printf("Previous song key\n");
                    }
                    else if( 200== ev[i].code)
                    {
                        printf("recv PlayCD key\n");
                    }
                    else if( 201== ev[i].code)
                    {
                        printf("recv PauseCD key\n");
                    }
                }
            }
        }
